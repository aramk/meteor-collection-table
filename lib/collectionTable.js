...
_.each([getRow, getSelectedRow, setSelectedId, getSelectedId, deselect, getDomNode, setDomTableId,
  getDomTableId], function(func) {
  TemplateClass[func.name] = func;
});
...
TemplateClass.rendered = function() {
  ...
  function createHandlerContext(extraArgs) {
    return _.extend({id: getSelectedId(), selectedRow: getSelectedRow(), collection: collection,
      createRoute: createRoute, editRoute: editRoute}, extraArgs);
  }
