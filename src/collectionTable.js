...
function addSelection(domNode, ids) {
  ...
  $(domNode).trigger(selectEventName, {added: toSelectIds, removed: []});
}
...
function removeSelection(domNode, ids) {
  ...
  $(domNode).trigger(selectEventName, {added: [], removed: toDeselectIds});
}
